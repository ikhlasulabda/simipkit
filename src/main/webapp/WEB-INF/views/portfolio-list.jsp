...
<body>
    ...
    <div class="container">
        ...
        <div class="card mb-20" style="background-color: #f1f5f9;">
            <div style="font-size: 13px; color: #475569;">Total Nilai Portofolio Investasi:</div>
            <div style="font-size: 24px; font-weight: 700; color: #0f172a;">Rp <c:out value="${totalValue}"/></div>
        </div>
